...
# This algorithm train takes teh data hosted at wfsr data station node and returns a prediction value from it based on Bayesian network model
wfsrbn<-function(){
    Data<-read_csv("./data/wfsr_node/wfsr_data.csv",show_col_types = FALSE)
    set.seed(0)
...
#    Detection_probability_exter
    ...
    pred <- list(
        description = "Bayesian Network model learned from data hosted at WFSR",
